...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-src-mode-hook '(lambda () (if evil-mode (evil-emacs-state)))) 
#+end_src
*** Windmove bindings
...
#+begin_src emacs-lisp
  ...
  (evil-declare-key 'emacs Info-mode-map "j" 'evil-next-line)
  (evil-declare-key 'emacs Info-mode-map "k" 'evil-previous-line)
#+end_src
